...
class QueryCommand < DataService
  ...
  ASPECTS = {
    ...
    ptype:      FilterAspect.new( :ptype,
                                  :"ppd:propertyType",
                                  values: %i{lrcommon:detached lrcommon:semi-detached lrcommon:terraced lrcommon:flat-maisonette lrcommon:otherPropertyType },
                                  uri_value: true,
    ...
    et:         FilterAspect.new( :et,
                                  :"ppd:estateType",
                                  values: %i{lrcommon:freehold lrcommon:leasehold},
                                  uri_value: true,
                                  presentation_label: "estate type" ),
    tc:         FilterAspect.new( :tc,
                                  :"ppd:transactionCategory",
                                  values: %i{ppd:standardPricePaidTransaction ppd:additionalPricePaidTransaction},
                                  uri_value: true,
